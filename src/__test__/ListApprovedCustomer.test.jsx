...
describe('ListApprovedCustomer Component', () => {
  beforeEach(() => {

    jest.clearAllMocks();
  });

  it('renders the component and displays ListApprovedCustomer data', async () => {
    const mockData = [
      {
        id: 1,
        firstName: 'John',
    ...
    customerService.ListApprovedCustomers.mockResolvedValue({ data: { results: mockData } });

    render(
      <MemoryRouter>
        <ListApprovedCustomer />
      </MemoryRouter>
    );
    ...
    const mockNextPageData = [
      {
        ...
        customerService.ListApprovedCustomers
...
describe('Pagination buttons', () => {
  it('should fetch the previous page when "Previous" button is clicked', async () => {
    ...
    customerService.ListApprovedCustomers.mockResolvedValue({
      data: mockData,
    });
    ...
    render(
      <MemoryRouter>
        <ListApprovedCustomer mockData={mockData} />
      </MemoryRouter>
    );
